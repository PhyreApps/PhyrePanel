<x-filament-panels::page>
    ...
    <div>
        ...
        @endif
            ...
            <div class="repair-tool-wrapper grid grid-cols-1 sm:grid-cols-2 gap-4 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                <!-- Repair Tool Action 1 -->
                <div wire:click="runRepair" class="repair-tool-action flex items-center space-x-3 p-4 bg-blue-500 dark:bg-blue-700 rounded-lg cursor-pointer transition-all hover:bg-blue-600 dark:hover:bg-blue-800 text-white disabled:opacity-50 disabled:cursor-not-allowed" wire:loading.attr="disabled">
                    ...
                    <!-- Loading Spinner -->
                    <div wire:loading wire:target="runRepair" class="ml-2 spinner-border animate-spin h-5 w-5 border-t-2 border-white rounded-full"></div>
                </div>

                <!-- Repair Tool Action 2 -->
                <div wire:click="runDomainRepair" class="repair-tool-action flex items-center space-x-3 p-4 bg-green-500 dark:bg-green-700 rounded-lg cursor-pointer transition-all hover:bg-green-600 dark:hover:bg-green-800 text-white disabled:opacity-50 disabled:cursor-not-allowed" wire:loading.attr="disabled">
                    ...
                    <!-- Loading Spinner -->
                    <div wire:loading wire:target="runDomainRepair" class="ml-2 spinner-border animate-spin h-5 w-5 border-t-2 border-white rounded-full"></div>
                </div>
            </div>

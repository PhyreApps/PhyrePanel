                    ...
                    <td class="w-6 p-4">
                        <div>
                            ...
                            @elseif($file['extension'] == 'zip')
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 text-purple-400" viewBox="0 0 24 24">
                            ...
                            @elseif ($file['extension'] == 'txt')
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 text-purple-400" viewBox="0 0 16 16">
